...
public class AdminProjectServiceImpl implements AdminProjectService {
    ...
    public Map<String, Object> summaryTheProject(String projectName) {
        ...
        Map<Integer, Integer> principleGraph = new HashMap<>();
        Map<Integer, Integer> segmentGraph = new HashMap<>();
        Map<Integer, Integer> quesGraph = new HashMap<>();
        Map<Integer, Integer> subQuesGraph = new HashMap<>();
        ethicalconcernsList.forEach(x -> {
            Integer points = x.getPoints();
            ...
            Integer quesPoint = quesGraph.getOrDefault(questionid, 0);
            Integer segmentPoint = segmentGraph.getOrDefault(segmentid, 0);
            Integer principlePoint = principleGraph.getOrDefault(principleid, 0);
